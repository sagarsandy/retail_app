...
import 'package:retail_app/features/mart/orders/presentation/pages/orders_m_page.dart';
...
class OrdersMPageRoute extends SSPageRoute {
  const OrdersMPageRoute(super.parentNavigatorKey);

  @override
  GoRoute getRoute() => GoRoute(
        name: SSAppRoutes.martOrders.name,
        path: SSAppRoutes.martOrders.navigationPath,
        ...
        pageBuilder: (BuildContext context, GoRouterState state) {
          ...
          return buildPageWithAnimation(
            ...
            state: state,
            child: SSBaseWidget(
              title: "Mart Orders Page",
              page: const OrdersMPage(),
            ),
          );
        },
      );
